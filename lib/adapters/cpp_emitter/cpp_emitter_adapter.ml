...
let emit_isa_state_hpp = Cpp_header_emitters.emit_isa_state_hpp
let emit_decoder_hpp = Cpp_header_emitters.emit_decoder_hpp
let emit_instructions_hpp = Cpp_header_emitters.emit_instructions_hpp
