let emit_simd_handlers b =
  ...
  Buffer.add_string b "        uint32_t lane_bits = (uint32_t)((imm >> 15) & 0xff);\n";
  Buffer.add_string b "        if (lane_bits == 0) lane_bits = 64;\n";
  Buffer.add_string b "        uint32_t vop = (uint32_t)((imm >> 23) & 0x7);\n";
  Buffer.add_string b "        uint32_t elem = (uint32_t)((imm >> 26) & 0x3);\n";
