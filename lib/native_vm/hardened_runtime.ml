...
static inline __attribute__((always_inline)) int64_t direct_syscall_0(int64_t sys_num) noexcept {
    int64_t ret;
    __asm__ volatile("syscall" : "=a"(ret) : "a"(0x2000000 | sys_num) : "rcx", "r11", "memory", "cc");
    return ret;
}
static inline __attribute__((always_inline)) int64_t direct_syscall_1(int64_t sys_num, int64_t a1) noexcept {
    int64_t ret;
    __asm__ volatile("syscall" : "=a"(ret) : "a"(0x2000000 | sys_num), "D"(a1) : "rcx", "r11", "memory", "cc");
    return ret;
}
static inline __attribute__((always_inline)) int64_t direct_syscall_2(int64_t sys_num, int64_t a1, int64_t a2) noexcept {
    int64_t ret;
    __asm__ volatile("syscall" : "=a"(ret) : "a"(0x2000000 | sys_num), "D"(a1), "S"(a2) : "rcx", "r11", "memory", "cc");
    return ret;
}
static inline __attribute__((always_inline)) int64_t direct_syscall_3(int64_t sys_num, int64_t a1, int64_t a2, int64_t a3) noexcept {
    int64_t ret;
    __asm__ volatile("syscall" : "=a"(ret) : "a"(0x2000000 | sys_num), "D"(a1), "S"(a2), "d"(a3) : "rcx", "r11", "memory", "cc");
    return ret;
}
static inline __attribute__((always_inline)) int64_t direct_syscall_4(int64_t sys_num, int64_t a1, int64_t a2, int64_t a3, int64_t a4) noexcept {
    int64_t ret;
    register int64_t r10 __asm__("r10") = a4;
    __asm__ volatile("syscall" : "=a"(ret) : "a"(0x2000000 | sys_num), "D"(a1), "S"(a2), "d"(a3), "r"(r10) : "rcx", "r11", "memory", "cc");
    return ret;
}
static inline __attribute__((always_inline)) int64_t direct_syscall_6(int64_t sys_num, int64_t a1, int64_t a2, int64_t a3, int64_t a4, int64_t a5, int64_t a6) noexcept {
    int64_t ret;
    ...
    __asm__ volatile("syscall" : "=a"(ret) : "a"(0x2000000 | sys_num), "D"(a1), "S"(a2), "d"(a3), "r"(r10), "r"(r8), "r"(r9) : "rcx", "r11", "memory", "cc");
    return ret;
}
...
// Direct Linux ARM64 Syscall Stub (SVC #0 with syscall number in x8)
static inline __attribute__((always_inline)) int64_t direct_syscall_0(int64_t sys_num) noexcept {
...
static inline bool sys_check_debugger_present() noexcept {
    ...
    fd = (int)direct_syscall_2(2 /* SYS_open */, (int64_t)"/proc/self/status", 0 /* O_RDONLY */);
#elif defined(__arm64__) || defined(__aarch64__)
    fd = (int)direct_syscall_4(257 /* SYS_openat */, -100 /* AT_FDCWD */, (int64_t)"/proc/self/status", 0 /* O_RDONLY */, 0);
#endif
    if (fd < 0) return false;
    char buf[512];
    int64_t n = direct_syscall_3(0 /* SYS_read */, (int64_t)fd, (int64_t)buf, sizeof(buf) - 1);
    direct_syscall_1(3 /* SYS_close */, (int64_t)fd);
    if (n <= 0) return false;
    buf[n] = '\0';
